...
<main class="xbox-content">
    <div class="xbox-page space-y-6">
        <section class="xbox-hero">
            <span class="xbox-hero-eyebrow">Lançamentos</span>
            <h1 class="xbox-hero-title">Novos Jogos</h1>
            <p class="xbox-hero-subtitle">Descubra os lançamentos mais recentes com a identidade Xbox e cartões em vidro líquido.</p>
        </section>
            ...
            <div id="gamesList" class="friend-grid">
                <?php foreach ($current_page_products as $product) : ?>
                    <?php
                        ...
                        $category = $product['Properties']['Category'] ?? 'Categoria não disponível';
                    ?>
