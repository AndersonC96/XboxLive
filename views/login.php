    ...
    <div class="w-full max-w-md animate-fade-in">
        <div class="glass-card p-10 rounded-2xl border-white/10 shadow-2xl">
            ...
            <?php if (isset($_GET['success']) && $_GET['success'] === 'registered'): ?>
                <div class="bg-green-500/10 border border-green-500/50 text-green-400 px-4 py-3 rounded-xl mb-6 text-sm font-bold flex items-center gap-3">
            ...
            <div class="mt-8 pt-8 border-t border-white/5 text-center">
                <p class="text-gray-500 font-medium">
                    Não tem uma conta? 
                    <a href="register" class="text-xbox-green hover:text-xbox-green-light font-bold transition-colors">Crie agora</a>
                </p>
            </div>
        </div>
