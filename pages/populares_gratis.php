...
<main class="xbox-content">
    <div class="xbox-page space-y-6">
        <section class="xbox-hero">
            <span class="xbox-hero-eyebrow">Populares</span>
            <h1 class="xbox-hero-title">Jogos Grátis Populares</h1>
            <p class="xbox-hero-subtitle">Navegue pelos queridinhos gratuitos com o mesmo visual de vidro líquido e paginação temática.</p>
        </section>
                    ...
                    <article class="friend-card xbox-glass-card game-card" data-title="<?php echo htmlspecialchars(strtolower($title)); ?>">
                        <div class="game-card-body">
                            ...
                            <div class="game-details">
                                ...
                                <div class="game-price">Preço: <strong>Grátis</strong></div>
                            </div>
                        </div>
                    </article>
                <?php endforeach; ?>
