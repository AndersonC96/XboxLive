...
<main class="xbox-content">
    <div class="xbox-page space-y-6">
        <section class="xbox-hero">
            ...
            <h1 class="xbox-hero-title">Jogos Pagos Populares</h1>
            <p class="xbox-hero-subtitle">Visual alinhado ao restante do site para navegar pelos pagos mais populares.</p>
        </section>
