...
<main class="xbox-content">
    <div class="xbox-page space-y-6">
        <section class="xbox-hero">
            <span class="xbox-hero-eyebrow">Tendências</span>
            <h1 class="xbox-hero-title">Mais Jogados</h1>
            <p class="xbox-hero-subtitle">Explore os títulos mais jogados com cartões de vidro líquido e navegação consistente com o restante do site.</p>
        </section>
