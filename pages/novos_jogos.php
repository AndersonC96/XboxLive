...
<div class="container mx-auto p-4">
    <h1 class="text-3xl mb-4">Novos Jogos</h1>
            ...
            <?php foreach ($current_page_products as $product) : ?>
                <li class="mb-4">
                    <div class="flex items-center space-x-4">
                        <?php
                            $imageUri = '';
                            if (isset($product['LocalizedProperties'][0]['Images'])) {
                        ...
                        ?>
                        <img src="<?php echo $imageUri; ?>" alt="Imagem do jogo" class="w-16 h-16 rounded-full">
                        <div>
                            ...
                            <p class="text-sm text-gray-400">Categoria: <?php echo isset($product['Properties']['Category']) ? htmlspecialchars($product['Properties']['Category']) : 'Categoria não disponível'; ?></p>
                        </div>
                    </div>
                </li>
            <?php endforeach; ?>
