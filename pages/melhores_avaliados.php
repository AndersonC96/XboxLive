...
<main class="xbox-content">
    <div class="xbox-page space-y-6">
        <section class="xbox-hero">
            <span class="xbox-hero-eyebrow">Ranking</span>
            <h1 class="xbox-hero-title">Melhores Avaliados</h1>
            <p class="xbox-hero-subtitle">Os títulos mais bem avaliados com o visual em vidro líquido, busca e paginação temática.</p>
        </section>
